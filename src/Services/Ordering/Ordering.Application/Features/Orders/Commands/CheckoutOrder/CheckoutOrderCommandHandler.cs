...
namespace Ordering.Application.Features.Orders.Commands.CheckoutOrder
{
    class CheckoutOrderCommandHandler : IRequestHandler<CheckoutOrderCommand, int>
    {
        ...
        public async Task<int> Handle(CheckoutOrderCommand request, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation($"Order {newOrder.Id} placed succesfully!");
        ...
        {
            var email = new Email() { To = "barjunkey@gmail.com", Body = $"Order was created.", Subject = "Order was created" };
